...
//^locate corresponding 'div' for each letter
//the correct letter will be filled-in at the corresponding div in the word container
...
(function startGame() {
  ...
  for (const button of document.querySelectorAll('button')) {
    ...
    //if guess is correct, invoke handleCorrectGuess 
    if (isLetterInWord(letter)) {
      handleCorrectGuess(letter);
    } 
    //if guess is incorrect, invoke handleWrongGuess
    else  {
      handleWrongGuess();
    }
    })  
